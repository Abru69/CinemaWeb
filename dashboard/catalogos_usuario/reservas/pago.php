...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errores)) {
        ...
        $stmt_insert = $conn->prepare("INSERT INTO asientos_reservados (usuario_id, funcion_id, asiento, confirmado) VALUES (?, ?, ?, 1)");
        ...
        $stmt_insert->close(); // <-- solo cierra $stmt_insert aquí
...
<head>
    ...
    <!-- Elimina el bloque <style> interno -->
</head>
<body>
    <main>
    <div class="pago-form">
